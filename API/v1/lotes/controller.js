...
exports.post = async (req, res, next) => {
		...
		const result = await create(req.body, user, Lote);
...
exports.put = async (req, res, next) => {
	...
	const returnList = await update(req.params.id, req.body, Lote);
...
exports.getList = async (req, res, next) => {
    try {
		...
		const returnList = await findList({}, Lote);
...
exports.getById = async (req, res, next) => {
	try {
		...
		const returnList = await findById(req.params.id, options, Lote);
...
exports.deleteById = async (req, res, next) => {
	try {
		...
		const returnList = await remove(req.params.id, req.body, Lote);
